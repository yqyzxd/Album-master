...
/**
 * Common callback for an Interactor {@link Runnable} declared in the application.
 * This callback represents a execution unit for different use cases (this means any use case
